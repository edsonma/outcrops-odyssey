...
module GTK
  class Args
    ...
    def initialize runtime, recording, orientation_width, orientation_height
      @inputs = Inputs.new
      @runtime = runtime
      @recording = recording
      @grid = Grid.new runtime, orientation_width, orientation_height
      $grid ||= @grid
      ...
      @render_targets = {}
      @render_target_sizes = {}
      @render_target_state = RenderTargetState.new self
      @pixel_arrays = {}
      @all_tests = []
    ...
    def render_target name
      ...
      if !@render_targets[name]
        render_target_entry = render_target_state.__data__[name]
        if !render_target_entry
          render_target_state.global_last_changed_at = Kernel.global_tick_count
        ...
        render_target_data = {
          id: name,
          initial_position: render_target_state.__data__.size,
          path: name,
          ready: false,
        ...
        render_target_state.__data__[name] = render_target_data
      ...
      render_target_state.__data__[name].updated_at = Kernel.tick_count
      render_target_state.__data__[name].global_updated_at = Kernel.global_tick_count
    ...
    def tick_after
      ...
      render_target_state.__data__.each do |k, v|
        v[:ready] = true
      end
    end
